# Generated by Django 4.2.1 on 2023-10-22 12:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intested_in', models.CharField(blank=True, max_length=40, null=True)),
                ('education', models.CharField(blank=True, max_length=40, null=True)),
                ('Phone_number', models.IntegerField(blank=True, max_length=40, null=True)),
            ],
            options={
                'db_table': 'job_seeker',
            },
